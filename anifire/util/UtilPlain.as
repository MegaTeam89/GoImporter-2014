package anifire.util
{
   ...
   public class UtilPlain
   {
      ...
      public static function getCharacterFlip(param1:MovieClip) : MovieClip
      {
      ...
      public static function getColorItem(param1:DisplayObject, param2:String = "") : Array
      {
         ...
         var treatment:Function = function(param1:DisplayObject):void
         {
            ...
            if(param1 != null)
            {
               if(DisplayObject(param1).name.indexOf(THE_COLOR) > -1)
               {
                  _loc2_ = DisplayObject(param1).name.split("_");
                  if(spec == "" || spec != "" && _loc2_[1] == spec)
                  {
                     objArray.push(param1);
                  }
               }
      ...
      private static function getMultipleInstanceRecursive(param1:DisplayObject, param2:*, param3:Array) : void
      {
         ...
         if(param1 is DisplayObjectContainer)
         {
            ...
            {
               if(_loc5_ = _loc4_.getChildAt(_loc6_))
               {
      ...
      public static function centerAlignObj(param1:DisplayObject, param2:Rectangle, param3:Boolean) : void
      {
         ...
         var _loc6_:Point;
         (_loc6_ = new Point()).x = (_loc4_.left + _loc4_.right) / 2 * _loc5_;
         _loc6_.y = (_loc4_.top + _loc4_.bottom) / 2 * _loc5_;
         var _loc7_:Point;
         (_loc7_ = new Point()).x = (param2.left + param2.right) / 2;
      ...
      public static function flipObj(param1:DisplayObject, param2:Boolean = false, param3:Boolean = false) : Number
      {
         ...
         if((_loc6_ = param1 as DisplayObjectContainer) != null)
         {
      ...
      private static function transverseFamilyWithCheck(param1:DisplayObject, param2:Function) : void
      {
         ...
         if(param1 is DisplayObjectContainer)
         {
            ...
            {
               (_loc5_ = new Object())["rootNode"] = param1;
         ...
         while(true)
         {
            switch(param3)
            {
               case PROPERTY_SCALEX:
                  _loc5_ *= _loc4_.scaleX;
                  break;
               case PROPERTY_SCALEY:
                  _loc5_ *= _loc4_.scaleY;
            }
      ...
      public static function addFlashVarsToURLvar(param1:UtilHashArray, param2:URLVariables) : void
      {
         var _loc3_:int = 0;
         _loc3_ = 0;
         while(_loc3_ < param1.length)
         {
            if(param1.getKey(_loc3_).indexOf("fb_sig") != -1)
            {
               if(param1.getValueByIndex(_loc3_) == null || param1.getValueByIndex(_loc3_) == "")
               {
                  param2[param1.getKey(_loc3_)] = "~~~";
               }
               else
               {
                  param2[param1.getKey(_loc3_)] = param1.getValueByIndex(_loc3_);
               }
            }
            else
            {
      ...
      public static function rasterizeImage(param1:Boolean, param2:DisplayObjectContainer, param3:Rectangle) : void
      {
         ...
         if(param1)
         {
            (_loc8_ = new BitmapData(param3.width,param3.height)).draw(param2,null,null,null,param3,false);
            (_loc6_ = new Shape()).graphics.beginBitmapFill(_loc8_);
            ...
            {
               if((_loc7_ = param2.getChildAt(_loc5_)) != null)
               {
         ...
         else if((_loc6_ = param2.getChildByName(_loc4_) as Shape) != null)
         {
            _loc5_ = 0;
            while(_loc5_ < param2.numChildren)
            {
      ...
      public static function convertZipAsImagedataObject(param1:ZipFile) : Object
      {
         ...
         {
            if((_loc5_ = param1.entries[_loc4_]).name == "desc.xml")
            {
            ...
            else if(_loc5_.name.substr(_loc5_.name.length - 3,3).toLowerCase() == "swf")
            {
               ...
               {
                  (_loc7_ = new UtilCrypto()).decrypt(_loc6_);
               }
