package anifire.constant
{
   ...
   public class ServerConstants
   {
      ...
      public static const ACTION_GET_INIT_PARAMS:String = get_server_path() + "getInitParams/";
      ...
      public static const ACTION_GET_USER_ASSETS_XML:String = get_server_path() + "getUserAssetsXml/";
      
      public static const ACTION_SEARCH_TEMPLATE_CC:String = get_server_path() + "searchTemplateCCs/";
      ...
      public static const ACTION_GET_ALL_FAV_JSON:String = get_server_path() + "getAllFavoriteAssets/";
      
      public static const ACTION_ADD_FAV_JSON:String = get_server_path() + "addThemeAssetToFavorite/";
      
      public static const ACTION_REMOVE_FAV_JSON:String = get_server_path() + "removeThemeAssetFromFavorite/";
      ...
      public static function get SERVER_IMPORTER_PATH() : String
      {
         var _loc1_:UtilHashArray = Util.getFlashVar();
         var _loc2_:String = _loc1_.getValueByKey("v");
         var _loc3_:String = "importer.swf?v=" + _loc2_;
         if(URLUtil.getProtocol(FlexGlobals.topLevelApplication.url) != "file")
         {
            _loc3_ = "/static/animation/" + _loc3_;
         }
         return _loc3_;
      }
