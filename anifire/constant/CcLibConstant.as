package anifire.constant
{
   ...
   public class CcLibConstant
   {
      ...
      public static function get DEFAULT_HEADSCALES() : Array
      {
         ...
         if(Util.getFlashVar().getValueByKey(ServerConstants.PARAM_THEME_ID) == ThemeConstants.CHIBI_THEME_ID)
         {
            return [1,0.9,1.1,1.25];
         }
         if(Util.getFlashVar().getValueByKey(ServerConstants.PARAM_THEME_ID) == ThemeConstants.NINJA_THEME_ID)
         {
            return [1,0.9,1.1,1.25];
         }
         if(Util.getFlashVar().getValueByKey(ServerConstants.PARAM_THEME_ID) == ThemeConstants.BUSINESS_THEME_ID)
         {
            return [1.4];
         }
      ...
      public static function get CHANGE_CHAR_SCALE() : Boolean
      {
         ...
         if(THEME_RUN_TAG_INSTEAD_OF_BODYSHAPE(Util.getFlashVar().getValueByKey(ServerConstants.PARAM_THEME_ID)))
         {
            return false;
         }
         return true;
      ...
      public static function GET_COMPONENT_RELATED_LIBRARY(param1:String) : String
      {
         switch(param1)
         {
            ...
            case LIBRARY_TYPE_GOLOWER:
               if(Util.getFlashVar().getValueByKey(ServerConstants.PARAM_THEME_ID) == "anime")
               {
               }
         }
         return "";
      ...
      {
         if(Util.getFlashVar().getValueByKey(ServerConstants.PARAM_THEME_ID) == ThemeConstants.ANIME_THEME_ID || Util.getFlashVar().getValueByKey(ServerConstants.PARAM_THEME_ID) == ThemeConstants.NINJAANIME_THEME_ID)
         {
            if(UtilUser.hasAdminFeatures)
            {
               return true;
      ...
      public static function get DEFAULT_PREVIEW_SCALE() : Number
      {
         ...
         if(Util.getFlashVar().getValueByKey(ServerConstants.PARAM_THEME_ID) == ThemeConstants.NINJAANIME_THEME_ID)
         {
            return 1.2;
         }
         if(THEME_RUN_TAG_INSTEAD_OF_BODYSHAPE(Util.getFlashVar().getValueByKey(ServerConstants.PARAM_THEME_ID)))
      ...
      {
         switch(Util.getFlashVar().getValueByKey(ServerConstants.PARAM_THEME_ID))
         {
      ...
      public static function CHAR_TAG_MATCH_CURR_THEME(param1:Array) : Boolean
      {
         if(THEME_RUN_TAG_INSTEAD_OF_BODYSHAPE(Util.getFlashVar().getValueByKey(ServerConstants.PARAM_THEME_ID)))
         {
            if(param1.indexOf(Util.getFlashVar().getValueByKey("ft")) > -1)
            {
               return true;
            }
            return false;
