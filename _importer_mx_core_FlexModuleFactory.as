package
{
   ...
   public class _importer_mx_core_FlexModuleFactory extends FlexModuleFactory implements IFlexModuleFactory, ISWFContext
   {
      ...
      public function _importer_mx_core_FlexModuleFactory()
      {
         super();
      }
      ...
      override public function create(... rest) : Object
      {
         ...
         var _loc2_:String = rest.length == 0 ? "importer" : String(rest[0]);
